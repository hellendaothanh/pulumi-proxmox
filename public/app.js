            ...
            if (data.success && Array.isArray(data.data)) {
                ...
                if (ssoButtonsContainer && ssoProviders.length > 0) {
                    ssoButtonsContainer.innerHTML = ssoProviders.map(p => {
                        const statusTag = !p.configured ? `<span style="font-size:9.5px; opacity:0.8; background:rgba(245,158,11,0.2); color:#f59e0b; padding:2px 6px; border-radius:4px; margin-left:auto;">Setup Needed</span>` : `<span style="font-size:9.5px; opacity:0.8; background:rgba(34,197,94,0.2); color:#4ade80; padding:2px 6px; border-radius:4px; margin-left:auto;">Active</span>`;
